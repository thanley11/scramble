"""
Django settings for scramble_project project.
...
ROOT_URLCONF = 'scramble_project.urls'

WSGI_APPLICATION = 'scramble_project.wsgi.application'
...
TEMPLATE_DIRS = (
    ...
    TEMPLATE_PATH + "/scramble",
    TEMPLATE_PATH + "/registration",
)
