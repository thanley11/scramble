...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.handicap'
        db.add_column(u'scramble_course', 'handicap',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Course.location'
        db.add_column(u'scramble_course', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.handicap'
        db.delete_column(u'scramble_course', 'handicap')

        # Deleting field 'Course.location'
        db.delete_column(u'scramble_course', 'location')
